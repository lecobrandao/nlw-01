...
// array ou objeto: manualmente informar o tipo da variával
...
const CreatePoint = () => {
    ...
    useEffect(() => {
        ...
        axios.get<IBGECidade[]>(`https://servicodados.ibge.gov.br/api/v1/localidades/estados/${selectedUf}/municipios`).then(response => {
    ...
    function handleSelectItem(id: number) {
        const selecionado = selectedItems.findIndex(item => item === id);
